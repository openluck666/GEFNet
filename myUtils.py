...
class My_Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # 检查维度
        assert img0_Y.dim() == 3 and img0_Y.shape[0] == 1, "img0_Y must be a single-channel image"
        samples = {
            "img0_RGB": img0_RGB,
            "img0_gra": img0_gra,
            "img1_RGB": img1_RGB,
...
def validate(args, model, dataloader_val, epoch, logger, dataset_val_len):
    ...
    for _, samples in enumerate(dataloader_val):
        ...
        img1_gra = samples[0]['img1_gra'].cuda()
        #===========================================================================
        fus_Y = model( img0_Y = img0_Y,img1_RGB=img1_RGB,img0_RGB=img0_RGB,img1_Y = img1_Y)
        fus_Y = fus_Y.clamp(0,1)
